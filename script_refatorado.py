...
def knn_train_test1(train_col, target_col, dataframe):
    """knn_train_test"""
...
for col in train_cols:
    rmse_val = knn_train_test1(col, 'price', numeric_cars)
...
def knn_train_test2(train_col, target_col, dataframe):
    """knn_train_test"""
    np.random.seed(1)
...
def knn_train_test3(train_cols, target_col, dataframe):
    """knn_train_test"""
    np.random.seed(1)
...
def knn_train_test4(train_cols, target_col, dataframe):
    """knn_train_test"""
    np.random.seed(1)
